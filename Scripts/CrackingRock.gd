...
func start() -> void:
	...
	$Rock1s1.connect("body_entered", Callable(self, "_collide"))
	$Rock1s2.connect("body_entered", Callable(self, "_collide"))
...
func _crack():
	...
	$Rock1s1.disconnect("body_entered", Callable(self, "_collide"))
	$Rock1s2.disconnect("body_entered", Callable(self, "_collide"))
